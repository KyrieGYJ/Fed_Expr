...
def Dataset(args):
    ...
    if args.dataset == 'cifar10':
        ...
        trainset = CIFAR10(root=args.data_dir, train=True, download=False, transform=tra_trans)
        testset = CIFAR10(root=args.data_dir, train=False, download=False, transform=val_trans)
